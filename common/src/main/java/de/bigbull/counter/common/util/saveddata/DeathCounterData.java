package de.bigbull.counter.common.util.saveddata;
...
public class DeathCounterData extends SavedData {
    ...
    public static final Factory<DeathCounterData> FACTORY = new Factory<>(DeathCounterData::new, DeathCounterData::load, DataFixTypes.LEVEL);
