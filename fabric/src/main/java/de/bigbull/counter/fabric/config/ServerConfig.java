...
//
//    /**
//     * Synchronisiert die Konfiguration mit allen verbundenen Clients.
//     */
//    public void syncToClients() {
//        MinecraftServer server = TempConfig.getCurrentServer();
//        if (server != null && !server.getPlayerList().getPlayers().isEmpty()) {
//            Counter.logger.info("Synchronizing server config to {} clients",
//                    server.getPlayerList().getPlayers().size());
//            ServerConfigPacket packet = ServerConfigPacket.fromServerConfig(this);
//            Services.PLATFORM.sendPacketToAllClient(packet, server);
//        }
//    }
//
//    /**
//     * Speichert die Konfiguration und synchronisiert sie mit allen Clients.
//     */
...
//            }
//
//            // Synchronisiere nach dem Speichern
//            syncToClients();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
