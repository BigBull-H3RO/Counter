package de.bigbull.counter.forge.config;
...
public class Config {
    ...
    public static class Client implements IClientConfig {
        public static ForgeConfigSpec.BooleanValue SHOW_DAY_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_DAY_OVERLAY_ALWAYS;
        public static ForgeConfigSpec.DoubleValue DAY_OVERLAY_X;
        public static ForgeConfigSpec.DoubleValue DAY_OVERLAY_Y;
        public static ForgeConfigSpec.DoubleValue DAY_OVERLAY_SIZE;
        public static ForgeConfigSpec.IntValue DAY_OVERLAY_TEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_LIST_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_LIST_OVERLAY_ALWAYS;
        public static ForgeConfigSpec.DoubleValue DEATH_LIST_X;
        public static ForgeConfigSpec.DoubleValue DEATH_LIST_Y;
        public static ForgeConfigSpec.DoubleValue DEATH_LIST_SIZE;
        public static ForgeConfigSpec.IntValue DEATH_OVERLAY_WIDTH;
        public static ForgeConfigSpec.EnumValue<IClientConfig.DeathListOverlayStyle> DEATH_OVERLAY_STYLE;
        public static ForgeConfigSpec.IntValue DEATH_LIST_TEXT_COLOR;
        public static ForgeConfigSpec.IntValue FIRST_PLACE_COLOR;
        public static ForgeConfigSpec.IntValue SECOND_PLACE_COLOR;
        public static ForgeConfigSpec.IntValue THIRD_PLACE_COLOR;

        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_SELF_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_SELF_OVERLAY_ALWAYS;
        public static ForgeConfigSpec.DoubleValue DEATH_SELF_X;
        public static ForgeConfigSpec.DoubleValue DEATH_SELF_Y;
        public static ForgeConfigSpec.DoubleValue DEATH_SELF_SIZE;
        public static ForgeConfigSpec.IntValue DEATH_SELF_TEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue SHOW_TIME_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_TIME_OVERLAY_ALWAYS;
        public static ForgeConfigSpec.DoubleValue TIME_OVERLAY_X;
        public static ForgeConfigSpec.DoubleValue TIME_OVERLAY_Y;
        public static ForgeConfigSpec.DoubleValue TIME_OVERLAY_SIZE;
        public static ForgeConfigSpec.IntValue TIME_OVERLAY_TEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue SHOW_COORDS_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_COORDS_OVERLAY_ALWAYS;
        public static ForgeConfigSpec.DoubleValue COORDS_OVERLAY_X;
        public static ForgeConfigSpec.DoubleValue COORDS_OVERLAY_Y;
        public static ForgeConfigSpec.DoubleValue COORDS_OVERLAY_SIZE;
        public static ForgeConfigSpec.IntValue COORDS_OVERLAY_TEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue SHOW_PING_AS_TEXT;
        public static ForgeConfigSpec.IntValue PING_COLOR_GOOD;
        public static ForgeConfigSpec.IntValue PING_COLOR_MEDIUM;
        public static ForgeConfigSpec.IntValue PING_COLOR_BAD;

        public static ForgeConfigSpec.BooleanValue SHOW_EMOJIS;
    ...
    public static class Server implements IServerConfig {
        public static ForgeConfigSpec.BooleanValue ENABLE_DAY_COUNTER;
        public static ForgeConfigSpec.BooleanValue SHOW_DAY_OVERLAY;
        public static ForgeConfigSpec.BooleanValue ENABLE_DAY_MESSAGE;
        public static ForgeConfigSpec.BooleanValue SHOW_DAY_IN_CHAT;
        public static ForgeConfigSpec.IntValue DAY_CHATTEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue ENABLE_DEATH_COUNTER;
        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_OVERLAY;
        public static ForgeConfigSpec.IntValue MAX_PLAYERS_SHOWN;
        public static ForgeConfigSpec.EnumValue<IServerConfig.DeathOverlayMode> DEATH_OVERLAY_MODE;

        public static ForgeConfigSpec.BooleanValue ENABLE_DEATH_IN_CHAT;
        public static ForgeConfigSpec.EnumValue<IServerConfig.DeathInChatMode> DEATH_IN_CHAT_MODE;
        public static ForgeConfigSpec.EnumValue<IServerConfig.DeathChatMode> DEATH_CHAT_MODE;
        public static ForgeConfigSpec.BooleanValue SHOW_DEATH_LIST_ON_DEATH_GLOBAL;
        public static ForgeConfigSpec.IntValue DEATH_LIST_CHATTEXT_COLOR;
        public static ForgeConfigSpec.IntValue DEATH_SELF_CHATTEXT_COLOR;

        public static ForgeConfigSpec.BooleanValue ENABLE_TIME_Counter;
        public static ForgeConfigSpec.BooleanValue SHOW_TIME_OVERLAY;
        public static ForgeConfigSpec.BooleanValue SHOW_COMBINED_DAY_TIME;
        public static ForgeConfigSpec.BooleanValue TIME_FORMAT_24H;

        public static ForgeConfigSpec.BooleanValue ENABLE_COORDS_COUNTER;
        public static ForgeConfigSpec.BooleanValue SHOW_COORDS_OVERLAY;
        ...
        public Server(ForgeConfigSpec.Builder builder) {
            ...
            builder.push("Coordinates Overlay Settings");
            ENABLE_COORDS_COUNTER = builder.comment("If disabled, the coordinates overlay will not be displayed.")
                    .define("enableCoordsCounter", true);
            SHOW_COORDS_OVERLAY = builder.comment("Allow the coordinates overlay to be displayed for players?")
