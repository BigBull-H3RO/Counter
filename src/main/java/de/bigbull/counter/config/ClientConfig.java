...
public class ClientConfig {
    ...
    public static final ModConfigSpec.EnumValue<de.bigbull.counter.util.gui.OverlayAlignment> FPS_OVERLAY_ALIGN;
    ...
    static {
        ...
        SHOW_FPS_OVERLAY = CLIENT_BUILDER.comment("Enable/disable the fps counter overlay on the client side.")
        ...
        FPS_OVERLAY_ALIGN = CLIENT_BUILDER.comment("Alignment for the fps counter overlay.")
                .translation("counter.config.fpsOverlayAlign").defineEnum("fpsOverlayAlign", OverlayAlignment.RIGHT);
        FPS_OVERLAY_TEXT_COLOR = CLIENT_BUILDER.comment("Color for the fps counter overlay text.")
                .translation("counter.config.fpsOverlayTextColor").defineInRange("fpsOverlayTextColor", 0xFFFFFF, 0x000000, 0xFFFFFF);
        CLIENT_BUILDER.pop();
